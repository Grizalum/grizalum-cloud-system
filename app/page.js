...
export default function GrizalumFinancial() {
  ...
  const [misClientes, setMisClientes] = useState([
    {
      id: 1, nombre: 'Antonio Rodriguez', email: 'antonio@example.com', telefono: '+51 999 123 456',
      capital: 10000, cuotaMensual: 633.30, totalCobrar: 11399.40, saldoPendiente: 8000.00, 
      pagosRecibidos: 3399.40, estado: 'En Proceso', fechaInicio: '2024-01-15', tasaInteres: 14, 
      plazoMeses: 18, fechaVencimiento: '2025-07-15',
      historialPagos: [
    ...
    {
      id: 2, nombre: 'Maria Gonzalez', email: 'maria@example.com', telefono: '+51 987 654 321',
      capital: 15000, cuotaMensual: 950.00, totalCobrar: 17100.00, saldoPendiente: 12000.00,
      pagosRecibidos: 5100.00, estado: 'En Proceso', fechaInicio: '2024-03-01', tasaInteres: 14,
      plazoMeses: 18, fechaVencimiento: '2025-09-01',
      historialPagos: [
  ...
  const [misDeudas, setMisDeudas] = useState([
    {
      id: 1, acreedor: 'Banco Santander', descripcion: 'Prestamo comercial para capital de trabajo',
      capital: 50000, cuotaMensual: 2500.00, saldoPendiente: 45000.00, tasaInteres: 18,
      estado: 'Activo', proximoPago: '2025-07-21', tipo: 'Prestamo Bancario'
    },
    {
      id: 2, acreedor: 'Proveedor Textil SAC', descripcion: 'Compra de mercaderia a credito',
      capital: 8000, cuotaMensual: 800.00, saldoPendiente: 6400.00, tasaInteres: 0,
      estado: 'Activo', proximoPago: '2025-07-05', tipo: 'Credito Comercial'
    }
  ]);

  const [misInversiones, setMisInversiones] = useState([
    {
      id: 1, nombre: 'Maquina Soldadora Industrial', descripcion: 'Maquina profesional para metalurgia',
      tipo: 'Maquinaria', inversion: 12000, gananciaEsperada: 2500, gananciaActual: 1625,
      estado: 'En Proceso', roi: 20.8, progreso: 65
    },
    {
      id: 2, nombre: 'Local Comercial Centro', descripcion: 'Alquiler de local estrategico',
      tipo: 'Inmueble', inversion: 25000, gananciaEsperada: 5000, gananciaActual: 3750,
      estado: 'En Proceso', roi: 25.0, progreso: 75
    }
  ]);

  const [alertas, setAlertas] = useState([
    { 
      id: 1, mensaje: 'Pago de Antonio Rodriguez vence en 3 dias', urgencia: 'media', 
      tipo: 'pago_pendiente', fechaVencimiento: '2025-06-29', activa: true, fechaCreacion: '2025-06-26'
    },
    { 
      id: 2, mensaje: 'Cuota BCP vence manana', urgencia: 'alta', tipo: 'deuda_vencimiento',
      fechaVencimiento: '2025-06-28', activa: true, fechaCreacion: '2025-06-27'
    }
  ]);
  ...
  const copiarReporte = () => {
    const mensaje = `GRIZALUM COMPANIA METALURGICA
...
Gestion Profesional con Firebase
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between p-6 border-b border-slate-700">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-300">Compania Metalurgica</p>
                </div>
              </div>
            ...
            <nav className="flex-1 mt-6 space-y-1 px-2">
              {[
                ...
                { id: 'deudas', label: 'Gestion Deudas', icon: TrendingDown },
          ...
          <div className="lg:hidden bg-white shadow-sm p-4 sticky top-0 z-30">
            <div className="flex items-center justify-between">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600">Compania Metalurgica</p>
              </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-lg">COMPANIA METALURGICA</p>
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    {firebaseConectado ? (
                      ...
                      <>
                        ...
                        <span className="text-red-400 font-semibold">Sin Conexion</span>
                      </>
                    )}
                  </div>
            ...
            <div className="mb-6 bg-white rounded-2xl shadow-xl p-4">
              <div className="flex flex-wrap gap-3 justify-center lg:justify-end">
                ...
                <button onClick={guardarDatos} disabled={sincronizando}
                  className={`${sincronizando ? 'bg-orange-500' : datosGuardados ? 'bg-green-600' : 'bg-purple-500'} text-white px-4 py-2 rounded-xl transition-all flex items-center text-sm font-semibold`}>
                  {sincronizando ? (
                    <>
            ...
            <div className="mb-6 bg-green-50 border-l-4 border-green-400 rounded-r-2xl p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">Informacion protegida en la nube de Google.</p>
                </div>
              </div>
            </div>
            ...
            {currentView === 'resumen' && (
              <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  ...
                  <p className="text-gray-600 mb-4">Analisis completo en tiempo real</p>
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-2xl shadow-lg">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-blue-200 text-xs mt-1">{balanceNeto >= 0 ? 'Favorable' : 'Atencion'}</p>
                        </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-6 gap-4">
                    <div>
                      ...
                      <p className="text-gray-600">Gestion de prestamos y cobranzas</p>
                    </div>
                  ...
                  {filtrarPorBusqueda(misClientes, ['nombre', 'email', 'telefono']).length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 text-sm">Intenta con otros terminos</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {currentView === 'deudas' && (
              <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-6 gap-4">
                    <div>
                      <h2 className="text-2xl font-bold text-gray-800">Gestion de Deudas</h2>
                      <p className="text-gray-600">Control de obligaciones financieras</p>
                    </div>
                    <button onClick={() => alert('Nueva deuda proximamente')}
                        ...
                        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                              ...
                              <span className="text-sm text-gray-600">Proximo: {deuda.proximoPago}</span>
                            </div>
                          </div>
                          ...
                          <div className="flex lg:flex-col space-x-2 lg:space-x-0 lg:space-y-2">
                            ...
                            <button onClick={() => alert('Editar deuda proximamente')}
                              className="bg-blue-500 text-white p-3 rounded-lg hover:bg-blue-600 transition-all shadow-lg flex-1 lg:flex-none"
                              title="Editar Deuda">
                              <Edit size={18} />
                            </button>
                            <button onClick={() => confirm('Eliminar esta deuda?') && setMisDeudas(misDeudas.filter(d => d.id !== deuda.id))}
                              className="bg-red-500 text-white p-3 rounded-lg hover:bg-red-600 transition-all shadow-lg flex-1 lg:flex-none"
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6">
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mb-6 gap-4">
                    <div>
                      ...
                      <p className="text-gray-600">Gestion de activos y ROI</p>
                    </div>
                    <button onClick={() => alert('Nueva inversion proximamente')}
                        ...
                        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                              <div className="bg-white p-4 rounded-lg shadow-sm">
                                <p className="text-sm text-gray-600 mb-1">Inversion</p>
                            ...
                            <div className="mb-4">
                              <div className="flex justify-between text-sm mb-2">
                                <span className="text-gray-600">Progreso de Inversion</span>
                          ...
                          <div className="flex lg:flex-col space-x-2 lg:space-x-0 lg:space-y-2">
                            <button onClick={() => alert('Actualizar ROI proximamente')}
                              className="bg-green-500 text-white p-3 rounded-lg hover:bg-green-600 transition-all shadow-lg flex-1 lg:flex-none"
                              title="Actualizar Ganancias">
                              <TrendingUp size={18} />
                            </button>
                            <button onClick={() => alert('Editar inversion proximamente')}
                              className="bg-blue-500 text-white p-3 rounded-lg hover:bg-blue-600 transition-all shadow-lg flex-1 lg:flex-none"
                              title="Editar Inversion">
                              <Edit size={18} />
                            </button>
                            <button onClick={() => confirm('Eliminar esta inversion?') && setMisInversiones(misInversiones.filter(i => i.id !== inversion.id))}
                              className="bg-red-500 text-white p-3 rounded-lg hover:bg-red-600 transition-all shadow-lg flex-1 lg:flex-none"
                    ...
                    {alertas.map(alerta => (
                      <div key={alerta.id} className={`border rounded-xl p-6 hover:shadow-lg transition-all ${
                        ...
                        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                          ...
                          <div className="flex lg:flex-col space-x-2 lg:space-x-0 lg:space-y-2">
                            <button onClick={() => alert('Editar alerta proximamente')}
                              className="bg-blue-500 text-white p-3 rounded-lg hover:bg-blue-600 transition-all shadow-lg flex-1 lg:flex-none"
                              title="Editar Alerta">
                              <Edit size={18} />
                            </button>
